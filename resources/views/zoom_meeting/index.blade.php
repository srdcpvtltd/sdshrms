                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="user-group">
                                            ...
                                            <img alt="image" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$projectUser->name}}" @if($projectUser->avatar) src="{{asset(Storage::url('uploads/avatar/')).'/'.$projectUser->avatar}}" @else src="{{asset(Storage::url('uploads/avatar/avatar.png'))}}" @endif class="rounded-circle " width="25" height="25">
                                    @endforeach
                                        </div>
                                    </td>
                                    <td>
