                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('employee_id', $employeesId, ['class' => 'form-control','id' => 'employee_id']); ?>
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('reporting_manager_id', $reportingManagers, null, ['class' => 'form-control reporting_manager_id', 'placeholder' => 'Select Reporting Manager', 'id' => 'reporting_manager_id'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\upwork\debendra\sdshrms\resources\views/employee/create.blade.php ENDPATH**/ ?>