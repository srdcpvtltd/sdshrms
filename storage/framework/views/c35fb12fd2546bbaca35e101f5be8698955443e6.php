                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::text('employee_id', $employeesId, ['class' => 'form-control', 'disabled' => 'disabled','id' => 'employee_id']); ?>
            ...
            <div class="row">
                    ...
                    <div class="col-md-6 ">
                        <div class="card em-card " style="height: 506px">
                            <div class="card-header">
                                <h5><?php echo e(__('Reporting Manager')); ?></h5>
                            </div>
                            <div class="card-body employee-detail-create-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <?php echo e(Form::label('reporting_manager_id', __('Select Reporting Manager*'), ['class' => 'form-label'])); ?>

                                        <div class="form-icon-user">
                                            <?php echo e(Form::select('reporting_manager_id', $reportingManagers, $reportingManagerId, ['class' => 'form-control reporting_manager_id', 'required' => 'required', 'placeholder' => 'Select Reporting Manager', 'id' => 'reporting_manager_id'])); ?>
...
<?php $__env->startPush('script-page'); ?>
    <script type="text/javascript">
        ...
        function getEmployeeID(gender) {
            ...
            $.ajax({
                url: '<?php echo e(route('employee.get_employee_id')); ?>',
                type: 'POST',
                data: {
                    "gender": gender,
                    "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\upwork\debendra\sdshrms\resources\views/employee/edit.blade.php ENDPATH**/ ?>