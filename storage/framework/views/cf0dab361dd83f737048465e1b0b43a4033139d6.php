            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <?php if($settings['discover_buy_now_link']): ?>
                    <a href="<?php echo e($settings['discover_buy_now_link']); ?>"
                        class="btn btn-primary rounded-pill"><?php echo e(__('Buy
                                                Now')); ?> <i
...
<?php /**PATH /home/u489860297/domains/srdcindia.co.in/public_html/hrms/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>