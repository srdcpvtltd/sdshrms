...
<?php if(Auth::user()->type == 'company' || Auth::user()->type == 'hr' || Auth::user()->isReportingManager()): ?>
...
<?php /**PATH D:\php\upwork\debendra\sdshrms\resources\views/leave/action.blade.php ENDPATH**/ ?>