                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="user-group">
                                            ...
                                            <img alt="image" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e($projectUser->name); ?>" <?php if($projectUser->avatar): ?> src="<?php echo e(asset(Storage::url('uploads/avatar/')).'/'.$projectUser->avatar); ?>" <?php else: ?> src="<?php echo e(asset(Storage::url('uploads/avatar/avatar.png'))); ?>" <?php endif; ?> class="rounded-circle " width="25" height="25">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u489860297/domains/srdcindia.co.in/public_html/hrms/resources/views/zoom_meeting/index.blade.php ENDPATH**/ ?>